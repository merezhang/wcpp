...
const ws_char * const wscOutputStream ::s_class_name = "wcpp.io.wscOutputStream";
const ws_char * const wscPrintStream  ::s_class_name = "wcpp.io.wscPrintStream";
